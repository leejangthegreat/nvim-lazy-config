	...
	},
	{
		...
		opts = {
			on_attach = function(bufnr)
				...
				_map("n", "<LEADER>gp", gs.preview_hunk_inline, "Preview hunk info (diff)")
				_map("n", "<LEADER>gb", function()
				...
				_map("n", "<LEADER>gD", function()
					gs.diffthis("~")
				end, "Diff this ~")

				_map({ "o", "x" }, "<LEADER>gv", ":<C-U>Gitsigns select_hunk<CR>", "Select hunk")
			end,
		},
	},
	{
